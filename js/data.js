...
const PROJECTS = [
  ...
  },
  {
    ...
    desc:'Projekt muzyczny wykorzystujący klarnet, pianino, syntezatory oraz wiele innych instrumentów. Założeniem projektu jest odzyskiwanie atmosfery i ekspresji poprzez wykorzystanie jak najbardziej okrojonych form kompozycyjnych. Innymi słowy, ukazanie jak najszerszego spektrum emocji, barwy i lekkości przy użyciu jak najmniejszej ilości środków muzycznych.',
  ...
  },
  {
    ...
    desc:'Współpraca artystyczna dookoła form alternatywnego rocka, funku i krautrocka, z takimi twórcami jak Bernard Milé, Jędrek Woźniak czy Michał Kilijanek. Koncerty na licznych festiwalach oraz w warszawskiej Naroczy N13 czy squacie Przychodnia.',
